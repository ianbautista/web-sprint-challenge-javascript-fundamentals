...
`The variable internal is in the immediate scope of the nestedFunction. 
    Functions can look out of their immediate code block but not inside other function. This gives it closure.`;
